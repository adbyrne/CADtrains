#!/usr/bin/env python3
"""
Standard station — gable end wall panel.
...
Output:
  FCStd: CADtrains/Station/freecad/Std_GableWall.FCStd
  STL:   CADtrains/Station/printed_files/Std_GableWall.stl
"""
...
BLDG_D    = ft(15, 0)   # 52.6mm  (standard full depth)
...
print(f"Std Gable Wall: {BLDG_D:.1f} x {WALL_H:.1f} x {WALL_T}mm  (print qty: 2)")
...
# ---- Export -----------------------------------------------------------------
fc_path = "/home/abyrne/Projects/Trains/CADtrains/Station/freecad/Std_GableWall.FCStd"
try: FreeCAD.closeDocument("Std_GableWall")
except: pass
doc = FreeCAD.newDocument("Std_GableWall")
...
stl = "/home/abyrne/Projects/Trains/CADtrains/Station/printed_files/Std_GableWall.stl"
